...
return {
  ...
  },
  {
    ...
    config = function(_, opts)
      ...
      vim.api.nvim_command("highlight k.function.method guifg=#d0d0ff guibg=None")
      ...
      vim.api.nvim_set_hl(0, "@type.definition", { link = "k.module" })
      ...
      vim.api.nvim_set_hl(0, "@keyword.function", { link = "k.keyword" })
      ...
      vim.api.nvim_set_hl(0, "@module", { link = "k.module" })
